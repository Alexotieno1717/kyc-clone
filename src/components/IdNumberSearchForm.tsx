...
interface IdNumberSearchFormProps {
    refreshData: () => void;
}

const IdNumberSearchForm: React.FC<IdNumberSearchFormProps> = ({ refreshData }) => {
    ...
    return (
        <div className="w-full max-w-5xl">
            <div className="rounded-2xl bg-gradient-to-br from-white to-slate-50 p-4 md:p-5">
                <div className="mb-4">
                    <h3 className="text-lg font-semibold text-slate-900">Search by ID Number</h3>
                    <p className="mt-1 text-sm text-slate-600">
                        Enter an ID number to fetch identity details.
                    </p>
                </div>

                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-3 md:grid-cols-12 md:items-end md:gap-4">
                    <div className="md:col-span-10">
                        <label htmlFor="idNumberSearch" className="mb-1 block text-xs font-semibold uppercase tracking-wide text-slate-500">
                            ID Number
                        </label>
                        <input
                            id="idNumberSearch"
...
export default IdNumberSearchForm;
